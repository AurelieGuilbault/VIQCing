...
```{r echo=FALSE}
holeDataset <- read.table("holesdummySet.txt", sep="\t")
holeDataset[,1:5]
```
```{r}
result <- VIQCing::imputation("holesdummySet.txt", method = "knn", transformation = "log", compound = 1, metabolite = 2, sampleStart = 3)
result[, 1:5]
```
